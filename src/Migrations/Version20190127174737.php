 ...
 */
final class Version20190127174737 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649DC2902E0 ON user');
        $this->addSql('ALTER TABLE user DROP client_id_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD client_id_id INT DEFAULT NULL');
